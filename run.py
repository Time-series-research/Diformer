...
parser = argparse.ArgumentParser(description='Diformer & Transformer family for Time Series Forecasting')
...
parser.add_argument('--model', type=str, default='Transformer ',
                    help='model name, options: [Autoformer, Informer, Diformer, ReLSTM, DeepAR, DLinear, HI, PatchTST, STID]')

# data loader
parser.add_argument('--data_list', type=str,
                    default=['ETTm1', 'ETTm2'],
                    help='dataset type')
parser.add_argument('--data', type=str, default='J00170', help='dataset type')
